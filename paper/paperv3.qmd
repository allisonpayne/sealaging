...
# 17 observations where pup recruited but did not survive
problem_children <- filter(sealdat, puprecruited == 1 & !pup_survived)

sealdat <- anti_join(sealdat, problem_children, by = c("animalID", "pupID"))
```
