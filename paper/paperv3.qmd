...
$$
\pi_{1a} = \frac{\sum_{a=4}^{20} b(a)n(a)}{\sum_{a=4}^{20} n(a)}
$$
...
$$
\pi_{2a} = \frac{\sum_{a=4}^{11} b(a) n(a) + \sum_{a=12}^{20} b(11) n(a)}{\sum_{a=4}^{20}n(a)}
$$
...
$$
\pi_{1b} = \frac{\sum_{a=4}^{20} b(a) n(a) s(a)}{\sum_{a=4}^{20} n(a)}
$$

$$
\pi_{2b} = \frac{\sum_{a=4}^{11} b(a) n(a) s(a) + \sum_{a=12}^{20} b(11) n(a) (s11)}{\sum_{a=4}^{20}n(a)}
$$
